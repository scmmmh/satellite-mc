    ...
    'paths': {
                        ...
                        'content': {
                            'application/json': {
                                'schema': {
                                    'type': 'array',
                                    'items': {
                                        '$ref': '#/components/schemas/Turnout'
                                    }
                                }
                            }
                        }
            ...
            'post': {
                ...
                'requestBody': {
                    'content': {
                        'application/json': {
                            'schema': {
                                '$ref': '#/components/schemas/CreateTurnout'
                            }
                        }
                    }
                },
        ...
        '/api/turnouts/{tid}': {
            ...
            'delete': {
                ...
                'responses': {
                    '200': {
                        'description': 'The turnout has been deleted.'
                    },
                    '404': {
                        'description': 'The id does not identify an existing turnout'
                    }
        ...
        if body is not None and isinstance(body, dict):
            if "type" in body and body["type"] == "TwoPinSolenoidTurnout":
                if "params" in body and isinstance(body["params"], dict):
                    if "enable_pin" in body["params"] and "direction_pin" in body["params"] and "turnout_high" in body["params"]:  # noqa: E501
                        return True
        return False
